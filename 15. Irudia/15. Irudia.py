...
# 
# Intentsitatea ere definituko da. $i_{e}$-ren balioa finko mantendu da $t_{max}$ simulazio ia osorako. Azkenengo 15 ms-tan intentsitate negatibo bat sartu zaio neuronari. Azken honen helburua irudian ekintza potentzialei amaiera bat ematea da.
...
left, bottom, width, height = (0, -70, 70, 115)
...
left, bottom, width, height = (330, -70, 70, 115)
rect=mpatches.Rectangle((left,bottom),width,height, 
                        fill=False,
                        color="red",
                       linewidth=2)
...
plt.savefig('FS_Eredua_Vm.pdf', format='pdf', dpi=180,bbox_inches="tight")
plt.show()
